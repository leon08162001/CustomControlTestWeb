...
namespace APTemplate
{
    ...
    /// </list>
    /// </remarks>
    [ToolboxData("<{0}:CalendarRange runat=server></{0}:CalendarRange>")]
    [ToolboxBitmap(typeof(Calendar))]
    public class CalendarRange : TextBoxBase
    {
        /// <summary>
        /// 儲存第二個輸入方塊的控制項ID。
        /// </summary>
        ...
        public DateTime SecondDate
        {
            ...
            {
                if (DateFormat == DateFormat.年月日)
                    TextBox2.Text = value.ToString("yyyy/MM/dd");
                else if (DateFormat == DateFormat.年月)
                    TextBox2.Text = value.ToString("yyyy/MM");
                else if (DateFormat == DateFormat.年)
                    TextBox2.Text = value.ToString("yyyy");
                else if (DateFormat == DateFormat.年月日時分秒)
                    TextBox2.Text = value.ToString("yyyy/MM/dd HH:mm:ss");
                else if (DateFormat == DateFormat.年月日時分)
                    TextBox2.Text = value.ToString("yyyy/MM/dd HH:mm");
                else if (DateFormat == DateFormat.年月日時)
                    TextBox2.Text = value.ToString("yyyy/MM/dd HH");
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (NeedValidation)
            {
                ...
                {
                    REV1.ErrorMessage = "起始日期格式不正確(ex:2000/01/01)!";
                    REV1.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\s(((0?[1-9])|(1[0-2]))\:([0-5][0-9])((\s)|(\:([0-5][0-9])\s))([AM|PM|am|pm]{2,2})))?$";
                }
                else if (this.DateFormat == DateFormat.年月)
                {
                    REV1.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01)!";
                    REV1.ValidationExpression = @"^[0-9]{4}/(0[123456789]|(10|11|12))";
                }
                else if (this.DateFormat == DateFormat.年)
                {
                    REV1.ErrorMessage = Title + "=>日期格式不正確(ex:2000)!";
                    REV1.ValidationExpression = @"^[0-9]{4}";
                }
                else if (this.DateFormat == DateFormat.年月日時分秒)
                {
                    REV1.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00:00:00)!";
                    REV1.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0))):(([0-5]\d)|([1-9])):(([0-5]\d)|([1-9]))$";
                }
                else if (this.DateFormat == DateFormat.年月日時分)
                {
                    REV1.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00:00)!";
                    REV1.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0))):(([0-5]\d)|([1-9]))$";
                }
                else if (this.DateFormat == DateFormat.年月日時)
                {
                    REV1.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00)!";
                    REV1.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0)))$";
                }
                ...
                if (this.DateFormat == DateFormat.年月日)
                {
                    REV2.ErrorMessage = "結束日期格式不正確(ex:2000/01/01)!";
                    REV2.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\s(((0?[1-9])|(1[0-2]))\:([0-5][0-9])((\s)|(\:([0-5][0-9])\s))([AM|PM|am|pm]{2,2})))?$";
                }
                else if (this.DateFormat == DateFormat.年月)
                {
                    REV2.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01)!";
                    REV2.ValidationExpression = @"^[0-9]{4}/(0[123456789]|(10|11|12))";
                }
                else if (this.DateFormat == DateFormat.年)
                {
                    REV2.ErrorMessage = Title + "=>日期格式不正確(ex:2000)!";
                    REV2.ValidationExpression = @"^[0-9]{4}";
                }
                else if (this.DateFormat == DateFormat.年月日時分秒)
                {
                    REV2.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00:00:00)!";
                    REV2.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0))):(([0-5]\d)|([1-9])):(([0-5]\d)|([1-9]))$";
                }
                else if (this.DateFormat == DateFormat.年月日時分)
                {
                    REV2.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00:00)!";
                    REV2.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0))):(([0-5]\d)|([1-9]))$";
                }
                else if (this.DateFormat == DateFormat.年月日時)
                {
                    REV2.ErrorMessage = Title + "=>日期格式不正確(ex:2000/01/01 00)!";
                    REV2.ValidationExpression = @"^((\d{2}(([02468][048])|([13579][26]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))[\-\/\s]?((((0?[13578])|(1[02]))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\-\/\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\-\/\s]?((0?[1-9])|(1[0-9])|(2[0-8])))))) (([0-1]\d)|([1-9])|(2[0-3]|(0)))$";
                }
        ...
        protected override void CreateChildControls()
        {
            ...
            else if (this.DateFormat == DateFormat.年)
            {
                ...
                TextBox2.Text = SecondDate.ToString("yyyy");
            }
            else if (this.DateFormat == DateFormat.年月日時分秒)
            {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.DateFormat == DateFormat.年月日)
            {
                ...
                strJS1 = "dateFormat='yyyy/mm/dd';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            else if (this.DateFormat == DateFormat.年月)
            {
                strJS = "dateFormat='yyyy/mm';popUpCalendar(this, document.getElementById('" + TextBox1.ClientID + "'), dateFormat,-1,-1);";
                strJS1 = "dateFormat='yyyy/mm';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            else if (this.DateFormat == DateFormat.年)
            {
                strJS = "dateFormat='yyyy';popUpCalendar(this, document.getElementById('" + TextBox1.ClientID + "'), dateFormat,-1,-1);";
                strJS1 = "dateFormat='yyyy';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            else if (this.DateFormat == DateFormat.年月日時分秒)
            {
                strJS = "dateFormat='yyyy/mm/dd HH:mm:ss';popUpCalendar(this, document.getElementById('" + TextBox1.ClientID + "'), dateFormat,-1,-1);";
                strJS1 = "dateFormat='yyyy/mm/dd HH:mm:ss';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            else if (this.DateFormat == DateFormat.年月日時分)
            {
                strJS = "dateFormat='yyyy/mm/dd HH:mm';popUpCalendar(this, document.getElementById('" + TextBox1.ClientID + "'), dateFormat,-1,-1);";
                strJS1 = "dateFormat='yyyy/mm/dd HH:mm';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            else if (this.DateFormat == DateFormat.年月日時)
            {
                strJS = "dateFormat='yyyy/mm/dd HH';popUpCalendar(this, document.getElementById('" + TextBox1.ClientID + "'), dateFormat,-1,-1);";
                strJS1 = "dateFormat='yyyy/mm/dd HH';popUpCalendar(this, document.getElementById('" + TextBox2.ClientID + "'), dateFormat,-1,-1);";
            }
            if (IsShowButton)
            {
