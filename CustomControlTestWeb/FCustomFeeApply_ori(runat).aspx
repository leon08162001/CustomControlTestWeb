...
<body>
	...
	<div>
		<asp:Table runat="server" Width="90%">
			...
			<asp:TableRow runat="server">
				<asp:TableCell runat="server" Width="7%">
	...
	<asp:Table runat="server" Width="90%" Style="margin-bottom: 0px" BorderStyle="Solid"
		BorderWidth="1px" CellPadding="1" CellSpacing="1" BorderColor="#339966" GridLines="Both">
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" Width="9%">分公司:</asp:TableCell>
			<asp:TableCell runat="server" Width="18%">
				<asp:Label ID="Label6" runat="server" Text="永和分公司"></asp:Label>
			</asp:TableCell>
			<asp:TableCell runat="server" Width="7%">單位:</asp:TableCell>
			<asp:TableCell runat="server" Width="18%">證券一部</asp:TableCell>
			<asp:TableCell runat="server" Width="7%">員編:</asp:TableCell>
			<asp:TableCell runat="server" Width="18%">
				<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
			</asp:TableCell>
			<asp:TableCell runat="server" Width="7%">營業員:</asp:TableCell>
			<asp:TableCell runat="server" Width="18%">王大明</asp:TableCell>
		</asp:TableRow>
		<asp:TableRow runat="server">
			<asp:TableCell runat="server">主要帳號:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="3">
				<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
				<asp:Label ID="Label7" runat="server" Text="游釧茹"></asp:Label>
			</asp:TableCell>
			<asp:TableCell runat="server">關聯帳號:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="3">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server">異動原因:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
				<wcc:NewDropDownList ID="NewDropDownList1" runat="server" IsShowTitle="false" TitleBackColor="White"
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" ColumnSpan="1">客戶概況:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="5">
				<asp:Table runat="server">
					...
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" ColumnSpan="2">(變更折讓請檢附客戶最近三個月之業績)</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow runat="server">
			...
			<asp:TableCell runat="server" ColumnSpan="1">上傳附件:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="1">
				<wcc:Button_PopupWindow ID="Button_PopupWindow1" runat="server" />
			</asp:TableCell>
		</asp:TableRow>
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" RowSpan="2">申請資格:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1">下單方式:</asp:TableCell>
						<asp:TableCell runat="server">
							<asp:Table runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
								...
								<asp:TableRow runat="server">
									...
									<asp:TableCell runat="server" Width="30px"> 
									</asp:TableCell>
									<asp:TableCell runat="server">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server" Width="100%">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">扣除優惠手續費:</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<asp:Table runat="server">
								<asp:TableRow runat="server">
									<asp:TableCell runat="server" ColumnSpan="3">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" RowSpan="2">折讓條件:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server" Width="100%">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">折讓失效年月:</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<asp:Table runat="server">
								<asp:TableRow runat="server">
									<asp:TableCell runat="server" ColumnSpan="3">
										<wcc:PopupCalendar ID="PopupCalendar2" runat="server" TextBoxWidth="70px" Font-Size="Medium"
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server" Width="100%">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">傳統單折讓設定(月折):</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<asp:Table runat="server">
								<asp:TableRow runat="server">
					...
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">電子單折讓設定(月折):</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<asp:Table runat="server">
								<asp:TableRow runat="server">
					...
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">優惠手續費:</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<asp:Table runat="server">
								<asp:TableRow runat="server">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" RowSpan="2">其他條件:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server" Width="100%">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">外接資訊:</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server" ColumnSpan="7">
				<asp:Table runat="server" Width="100%">
					<asp:TableRow runat="server">
						<asp:TableCell runat="server" BorderColor="Black" BorderWidth="1" Width="13%">促銷方案:</asp:TableCell>
						<asp:TableCell runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
							Width="87%">
							<table cellpadding="1" cellspacing="0" border="1">
											<tr>
											...
											<tr class="rowcenter">
												<td>
													098S01(南崁七週年-<br>倚天C699(70萬折700)*12期)
												</td>
												<td>
													1
												</td>
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server">備註說明:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server">簽核意見:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
		...
		<asp:TableRow runat="server">
			<asp:TableCell runat="server">原申請條件:</asp:TableCell>
			<asp:TableCell runat="server" ColumnSpan="7">
