<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default100.aspx.cs" Inherits="Default100" %>
    ...
    <ContentTemplate>
      <div>
        ...
        <wcc:TabsView ID="TabsView1" runat="server" SelectedTabBackColor="DarkRed" TabBackColor="Yellow"
          ...
          TabTextBold="True" BorderColor="#FF3300" BorderWidth="2px" Height="1280px" TabPageLeftBackImageUrl="~/images/tai_button_01.gif"
          Width="1280px" SelectedTabPageCenterBackImageUrl="~/images/PageTab_center_1.gif"
          ...
          <Tabs>
            ...
            <wcc:TabPage ID="TabPage3" runat="server" Height="1200px" PaddingBottom="10px"
              PaddingLeft="10px" PaddingRight="10px" PaddingTop="10px" Style="padding-top: 10px;
              padding-bottom: 10px; padding-left: 10px; padding-right: 10px;" Text="Tab Item3"
              Width="979px" ToolTip="C" BorderColor="Red" BorderStyle="Solid" 
              BorderWidth="1px">
                  ...
                  <wcc:ToolBar ID="ToolBar2" runat="server" OnClick="ToolBar2_Click" ButtonHeight="20px"
                    ...
                    <Items>
                      ...
                      <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/wmv.ico"
                        ToolTip="閻亦格-我不是你想像那麼勇敢" ClickArgument="我不是你想像那麼勇敢.mp3" OverImageUrl="images/XLS.jpg"
                        ActiveImageUrl="images/VSD.jpg" OnClientClick="window.alert('AA');" />
                      <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/wmv.ico"
                        ToolTip="閻亦格-李香蘭.mp3" ClickArgument="李香蘭.mp3" ActiveImageUrl="~/images/drop2.gif" />
                      <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/wmv.ico"
          ...
          <Items>
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/icon_Dhome.gif"
              ToolTip="11 All rise.mp3" ClickArgument="11 All rise.mp3" OnClientClick="window.alert('How Are You?');"
              PostBackUrl="Default3.aspx" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="閻亦格-我不是你想像那麼勇敢" ClickArgument="我不是你想像那麼勇敢.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="閻亦格-李香蘭.mp3" ClickArgument="李香蘭.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="閻亦格-fighter.mp3" ClickArgument="fighter.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="images/separator.gif"
              IsSeperator="true" ClickArgument="E" ActiveImageUrl="~/images/gif_search_01.gif" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="11 All rise.mp3" ClickArgument="11 All rise.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="12 街角的祝福.mp3" ClickArgument="12 街角的祝福.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="13 EVERYTHING.mp3" ClickArgument="13 EVERYTHING.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="14 Hey Jude.mp3" ClickArgument="14 Hey Jude.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="17 If tomorrow never comes.mp3" ClickArgument="17 If tomorrow never comes.mp3"
              ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="18 我是女人.mp3" ClickArgument="18 我是女人.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="16 hitfm-016.mp3" ClickArgument="16 hitfm-016.mp3" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="閻亦格-讓一切隨風" ClickArgument="讓一切隨風.avi" ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarButton Enabled="True" Visible="True" ImageUrl="~/images/mp3.jpg"
              ToolTip="2012清晰完美中字版(www.an80.com).rmvb" ClickArgument="2012清晰完美中字版(www.an80.com).rmvb"
              ActiveImageUrl="~/images/mp3_play.jpg" />
            <wcc:ToolBarLabel Enabled="True" Text="ss" Visible="True" />
          ...
          <CustomControls>
            <wcc:CalendarRange ID="CalendarRange12" runat="server" FirstDate="2008-11-24"
              IsShowTitle="True" NeedValidation="True" NeedValue="True" SecondDate="2008-11-24"
              TextBoxID="" TextBoxID1="" TextBoxWidth="" TextLength="5000" Title="請輸入日期區間 : "
              TitleBackColor="Aqua" TitleForeColor="Sienna" TitleWidth="" ValidationType="NoCheck" />
